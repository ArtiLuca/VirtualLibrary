 ...
 *  Questa e' solitamente marcata come 'mutable' in modo da poter essere utilizzata in metodi marcati 'const', come ad esempio 'buildMedia()'.
 *
 ...
 *  Ho deciso di fare questo per facilitare operazioni in altri parti del progetto, come validazione, persistenza dati e per facilitare la
 *  creazione dei custom widget dell'interfaccia grafica.
 *
 */
