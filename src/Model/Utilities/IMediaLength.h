 ...
 *  Invece, il media concreto "Image" non la eredita in quanto non avrebbe logicamente senso applicare una durata ad un file immagine.
 *
 ...
 *  Ho fatto questa scelta per aiutare a differenziare i media della libreria, e per formare le basi semplici per poi implementare il polimorfismo in modo meno banale.
 *
