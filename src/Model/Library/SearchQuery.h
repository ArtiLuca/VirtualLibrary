 ...
 *
 *  Una operazione di ricerca nella libreria avviene tramite uno struct 'SearchQuery', passato per riferimento costante, con uno o piu' filtri impostati.
 ...
 *
 *  NOTA (3/6/25) - incluso header <cctype>
 *  Ho definito i due metodi statici 'checkExactMatchCaseInsensitive' e 'checkPartialMatchCaseInsensitive' per fare il check di un match esatto oppure parziale.
 *  Entrambi trattano il possibile match come "case-insensitive".
 *  Ad esempio, il match esatto e' solitamente fatto per 'mediaType', mentre il match parziale e' applicato ad esempio per 'mediaName'.
 *
 */
