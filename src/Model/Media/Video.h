 ...
 *  Un oggetto della classe Video rappresenta un film, cioe' un media aventa una durata (espressa in minuti) e una risoluzione (espressa come larghezza x altezza).
 *
 ...
 *  La classe Video e' concreta in quanto va a ridefinire i metodi virtuali puri ereditati da IMediaResolution, IMediaLength, AbstractMedia (e quindi anche AbstractFile)
 *  in modo specifico per il tipo Video.
 *
 *  In questa libreria virtuale, un media di tipo e' considerato valido se:
 *       - ha una durata espressa in minuti e una risoluzione con aspect ratio pari a 16:9
...
public:
    ...
    // costanti statiche per qualita' risoluzione
    // static const unsigned int res360P;
    // static const unsigned int res480P;
    // static const unsigned int res720P;
    // static const unsigned int res1080P;
    // static const unsigned int res1440P;
    // static const unsigned int res2160P;
    ...
    /**
     * @brief supportsHDR : verifica se il video puo' ha il support HDR
    ...
    /**
     * @brief getVideoQualityLabel : determina la qualita del video in base alla risoluzione, specificamente l'altezza
     * @return std::string : qualita' del video in base all'altezza della risoluzione (es: 1920x1080 = 1080p Full HD)
     */
    ...
    /** @brief toJson : ridefinizione virtuale puro ereditato da AbstractMedia per la persistenza dei dati in JSON (scrittura) per il tipo Video */
    QJsonObject toJson() const override;

    /** @brief fromJson :  ridefinizione virtuale puro ereditato da AbstractMedia per la persistenza dei dati in JSON (lettura) per il tipo Video */
