...
// const unsigned int Video::res360P = 360;
// const unsigned int Video::res480P = 480;
// const unsigned int Video::res720P = 720;
// const unsigned int Video::res1080P = 1080;
// const unsigned int Video::res1440P = 1440;
// const unsigned int Video::res2160P = 2160;
...
QJsonObject Video::toJson() const {
    ...
    json["uniqueID"] = static_cast<int>(getUniqueID());
...
void Video::fromJson(const QJsonObject& obj)  {
    ...
    if (obj.contains("uniqueID") && obj["uniqueID"].isDouble()) {
        setCurrentUniqueID(static_cast<unsigned int>( obj["uniqueID"].toInt()));
    }
