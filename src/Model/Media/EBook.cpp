 ...
 * Seguo il noto algoritmo checksum ISBN-13.
 *
 * Un media EBook di questa libreria virtuale ha un ISBN valido se:
    - E' composto da esattamente 13 caratteri numerici (senza spazi)
